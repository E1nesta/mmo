...
struct MetricsSnapshot {
    ...
    std::uint64_t gateway_login_success_total{};
    std::uint64_t gateway_login_failed_total{};
...
public:
    ...
    void record_gateway_login_success();
    void record_gateway_login_failed();
...
private:
    ...
    std::atomic<std::uint64_t> rpc_calls_total_{};
    ...
    std::atomic<std::uint64_t> gateway_login_success_total_{};
    std::atomic<std::uint64_t> gateway_login_failed_total_{};
